...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CreateEventState);
}
...
/// @nodoc
class $CreateEventStateCopyWith<$Res>  {
$CreateEventStateCopyWith(CreateEventState _, $Res Function(CreateEventState) __);
}
...
class _ToastError implements CreateEventState {
...
@override
String toString() {
  return 'CreateEventState.toastError(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ToastErrorCopyWith<$Res> implements $CreateEventStateCopyWith<$Res> {
...
class _ToastSuccess implements CreateEventState {
...
@override
String toString() {
  return 'CreateEventState.toastSuccess(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ToastSuccessCopyWith<$Res> implements $CreateEventStateCopyWith<$Res> {
...
class _ClosePage implements CreateEventState {
  const _ClosePage();
...
@override
String toString() {
  return 'CreateEventState.closePage()';
}
