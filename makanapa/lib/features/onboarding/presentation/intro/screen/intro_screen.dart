  ...
  Widget build(BuildContext context) {
    ...
    Widget introWidget() {
      return IntroductionScreen(
        pages: [
          PageViewModel(
            titleWidget: const GradientText('Masak Jadi Lebih Mudah'),
            body:
          ...
          PageViewModel(
            titleWidget: const GradientText('Belanja Jadi Terencana'),
            body:
          ...
          PageViewModel(
            titleWidget: const GradientText('Atur Menu Mingguanmu'),
            body:
          ...
          PageViewModel(
            titleWidget: const GradientText('Nikmati Hasilnya'),
            body:
